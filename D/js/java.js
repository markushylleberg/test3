...
$(".about1").click(function () {
    $('.awards_container').css('opacity', '0');
    $('.idea_container').css('opacity', '0');
    $('.press_container').css('opacity', '0');
    $('.vision_container').css('opacity', '0');
    $('.theteam_container').css('opacity', '1');
});


$(".about2").click(function () {
    $('.theteam_container').css('opacity', '0');
    $('.awards_container').css('opacity', '0');
    $('.idea_container').css('opacity', '0');
    $('.press_container').css('opacity', '0');
    $('.vision_container').css('opacity', '1');
});
...
$(".about3").click(function () {
    ...
    $('.press_container').css('opacity', '0');
    $('.vision_container').css('opacity', '0');
    $('.awards_container').css('opacity', '1');
});
